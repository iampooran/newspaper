                         ...
                         <div className="row">
                             {results.map((element) => {
                                 return <div className="col-md-4" key={element.url}>
                                     ...
                                     <img className='maingridImg' src='https://static01.nyt.com/images/2022/04/26/us/politics/26pol-jan6gop-mccarthy/merlin_197278008_974c85e2-e796-41d3-9e5c-177d3f7f5edb-jumbo.jpg?quality=75&auto=webp' alt="" />
                                 </div>
                             })}
                         </div>
                         </div>
